...
void menu(void)
{
    printf("\nChoose option:\n\n"
           "\t1 - TREE: Print tree\n"
           "\t2 - TREE: Print balanced tree\n"
           "\t3 - TREE: Remove point from tree\n\n"
           "\t4 - HASH: Create hash table using chain method\n"
           "\t5 - HASH: Print hashing table\n"
           "\t6 - HASH: Remove from hash table\n\n"
           "\t7 - Efficiency\n"
           "\t0 - Exit\n");
}
