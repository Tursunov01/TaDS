...
int main()
{
    ...
    int option;
    int flag = 0;
    int fill; // percentage of non-zero elements in matrix
    ...
    if (option)
    {
        ...
        printf("Input percentage of filling in range [0:100]: ");
        scanf("%d", &fill);
...
//            printf("\n\nSimple time result is: ");
//            printf("%d|\n", (time_2 - time_1)/10);
//            printf("Advanced time result is: ");
//            printf("%d|", (time_4 - time_3)/10);
            time_testing(n, m, fill);
        }
    ...
    {
        puts("Time testing: ");
        puts(" #elements | fill | Simple:   time (ms)           size (B) | Advanced:  time (ms)        size (B)");
        time_testing(10, 10, 5);
        time_testing(10, 10, 20);
        time_testing(10, 10, 50);
        time_testing(100, 100, 5);
        time_testing(100, 100, 17);
        time_testing(100, 100, 18);
        time_testing(100, 100, 19);
